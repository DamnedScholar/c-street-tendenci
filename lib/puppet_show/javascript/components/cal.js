...
class EventsCalendar extends LitElement{
...
prevMonth(){
  ...
  // TODO: Somehow, the BUI helper isn't getting imported correctly. Could be a Webpack issue or LitElement issue or who knows what. This is a band-aid that should be removed when the problem can be fixed.
...
export default customElements.define('events-calendar', EventsCalendar)
