...
from fs.copy import copy_file_internal
...
# TODO: Remove this file when I can. `_compare()` has been altered to remove the mtime comparison until the published release of the library implements `preserve_time`.

def _compare(info1, info2):
    # type: (Info, Info) -> bool
    """
    This function has been overridden.
    """
