...
// CONCATENATED MODULE: ./addons/tendenstreet/javascript/controllers/reactive_directory_controller.js



/* harmony default export */ const reactive_directory_controller = (class extends stimulus/* Controller */.Qr {
  connect() {
  ...
  increment(event) {
    ...
    event.preventDefault()
    this.stimulate('Reactive_DirectoryReflex#increment', 1)
  }
});

// CONCATENATED MODULE: ./addons/tendenstreet/javascript/reactive_directory.js
...
application.register("reactive_directory", reactive_directory_controller)
