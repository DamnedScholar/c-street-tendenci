...
// CONCATENATED MODULE: ./lib/puppet_show/javascript/controllers/calendar_controller.js



/* harmony default export */ const calendar_controller = (class extends stimulus/* Controller */.Qr {
  connect() {
    stimulus_reflex/* default.register */.Z.register(this)
  }

  increment(event) {
    console.log('increment')
    event.preventDefault()
    this.stimulate('CalendarReflex#increment', 1)
  }
});
...
class SVGTemplateResult extends TemplateResult {
    ...
    getTemplateElement() {
        ...
        /* unused export */ undefined(content, svgElement.firstChild);
        return template;
    }
}
 ...
 * render to and update a container.
 */
const svg = (strings, ...values) => new /* unused export */ undefined(strings, values, 'svg', defaultTemplateProcessor);
...
// CONCATENATED MODULE: ./node_modules/blackstone-ui/elements/btn-group.js
...
/* harmony default export */ const btn_group = (customElements.get('b-btn-group'));
// CONCATENATED MODULE: ./node_modules/blackstone-ui/helpers/lit-element/events.js
...
// CONCATENATED MODULE: ./node_modules/blackstone-ui/presenters/cal/day.js
...
/* harmony default export */ const day = (customElements.get('b-cal-day'));
// CONCATENATED MODULE: ./node_modules/blackstone-ui/presenters/cal/index.js
...
customElements.define('b-cal', class extends LitElement{
    ...
    constructor(){
        ...
        this.weekdays = moment_default().weekdaysMin()

        this.days = new Array(7*6).fill('')
        this.date = this._date || this.getAttribute('date') || moment_default()()
    }
    ...
    set date(val){
        ...
        if( val instanceof (moment_default()) ){
            this._date = val
			this._dateSelected = this._date.clone()

        }else if( typeof val == 'string' ){

            this._date = moment_default()(val)
			this._dateSelected = this._date.clone()
...
// CONCATENATED MODULE: ./lib/puppet_show/javascript/calendar.js
...
application.register("calendar", calendar_controller)
